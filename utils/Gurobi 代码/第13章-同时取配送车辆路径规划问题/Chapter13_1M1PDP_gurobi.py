...
name: 1-1 PDP优化问题- Gurobi Python接口代码实现
author: 王基光
date: 2022-10-11
"""
...
if __name__ == '__main__':
    ...
    PDVRP.setParam(GRB.Param.LogFile,"gurobipdp3.log")
    PDVRP.optimize()
    # 打印求解结果
    Slist=[]
    S = []
    ...
    plt.legend()
    plt.show()
    # PDVRP.setParam(GRB.Param.LogFile,"gurobipdp.log")
    # PDVRP.params.LogFile="gurobipdp922.log"
    summary=glt.get_dataframe(["gurobipdp.log"])
    print(0)
    # results = glt.parse(["gurobipdp.log"])
    # summary = results.summary()
    # nodelog_progress = results.progress("nodelog")
    glt.plot(summary, type="bar")
